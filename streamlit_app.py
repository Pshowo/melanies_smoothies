...
if ingredients_list:
    ...
    for fruit_chosen in ingredients_list:
        ...
        st.wrtie("The seach value for ", fruit_chosen, ' is ', seach_on, '.')
    ...
    my_instert_stmt = """insert into smoothies.public.orders(ingredients, name_on_order) values ('""" + ingredients_string + """', '"""+name_on_order+ """')"""
